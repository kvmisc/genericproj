...
#define XYZ_STATUS_BAR_HET (([UIScreen mainScreen].bounds.size.height>=812.0)?44.0:20.0)
#define XYZ_SAFE_AREA_TOP (([UIScreen mainScreen].bounds.size.height>=812.0)?44.0:0.0)
#define XYZ_SAFE_AREA_BOT (([UIScreen mainScreen].bounds.size.height>=812.0)?34.0:0.0)
